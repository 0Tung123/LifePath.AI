...
class AuthService {
   ...
   * Register a new user
   */ async register(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post('/auth/register', data);
    }
    /**
   * Login with email and password
   */ async login(credentials) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post('/auth/login', credentials);
        return response.data;
    }
    /**
   * Get current user profile
   */ async getProfile() {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get('/auth/profile');
        return response.data;
    }
    /**
   * Update user profile
   */ async updateProfile(data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].patch('/auth/profile', data);
        return response.data;
    }
    /**
   * Request password reset
   */ async forgotPassword(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post('/auth/forgot-password', data);
    }
    /**
   * Reset password with token
   */ async resetPassword(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post('/auth/reset-password', data);
    }
    /**
   * Verify email with token
   */ async verifyEmail(token) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`/auth/verify-email?token=${token}`);
    }
    /**
   * Resend verification email
   */ async resendVerification(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post('/auth/resend-verification', data);
    }
    /**
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkAuth = async ()=>{
            try {
                if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].isAuthenticated()) {
                    const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].getProfile();
                    setUser(userProfile);
                }
            } catch (err) {
                console.error("Failed to fetch user profile:", err);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].logout();
            } finally{
                setIsLoading(false);
            }
        };
    ...
    const login = async (credentials)=>{
        ...
        setError(null);
        try {
            const { access_token } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].login(credentials);
    ...
    const register = async (data)=>{
        ...
        setError(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].register(data);
        } catch (err) {
...
"[project]/src/services/game.service.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class GameService {
   ...
   */ async createGame(createGameData) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post('/games', createGameData);
        return response.data;
    }
    /**
   ...
   */ async makeChoice(gameId, choiceNumber) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(`/games/${gameId}/choice`, {
            choiceNumber
        });
        return response.data;
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react-jsx-dev-runtime.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$game$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/game.service.ts [app-rsc] (ecmascript)");
;
;
;
...
const GameProvider = ({ children })=>{
    const [currentGame, setCurrentGame] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const createGame = async (gameSettings)=>{
        ...
        try {
            ...
            const game = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$game$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createGame(createGameDto);
            setCurrentGame(game);
            return game;
        } catch (err) {
    ...
    const makeChoice = async (choiceNumber)=>{
        ...
        setError(null);
        try {
            const updatedGame = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$game$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].makeChoice(currentGame.id, choiceNumber);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$GameContext$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/GameContext.tsx [app-rsc] (ecmascript)");
;
;
;
...
const metadata = {
    ...
    description: "An immersive text-based role-playing game adventure"
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6813e51._.js.map