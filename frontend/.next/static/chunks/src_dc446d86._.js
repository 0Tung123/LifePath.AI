...
class AuthService {
   ...
   * Register a new user
   */ async register(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/register', data);
    }
    /**
   * Login with email and password
   */ async login(credentials) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', credentials);
        return response.data;
    }
    /**
   * Get current user profile
   */ async getProfile() {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/auth/profile');
        return response.data;
    }
    /**
   * Update user profile
   */ async updateProfile(data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch('/auth/profile', data);
        return response.data;
    }
    /**
   * Request password reset
   */ async forgotPassword(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/forgot-password', data);
    }
    /**
   * Reset password with token
   */ async resetPassword(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/reset-password', data);
    }
    /**
   * Verify email with token
   */ async verifyEmail(token) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/auth/verify-email?token=${token}`);
    }
    /**
   * Resend verification email
   */ async resendVerification(data) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/resend-verification', data);
    }
    /**
...
const AuthProvider = ({ children })=>{
        ...
        "AuthProvider.useEffect": ()=>{
            const checkAuth = {
                "AuthProvider.useEffect.checkAuth": async ()=>{
                    try {
                        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].isAuthenticated()) {
                            const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getProfile();
                            setUser(userProfile);
                        }
                    } catch (err) {
                        console.error("Failed to fetch user profile:", err);
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].logout();
                    } finally{
                        setIsLoading(false);
                    }
                }
    ...
    const login = async (credentials)=>{
        ...
        setError(null);
        try {
            const { access_token } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].login(credentials);
    ...
    const register = async (data)=>{
        ...
        setError(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].register(data);
        } catch (err) {
...
"[project]/src/services/game.service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class GameService {
   ...
   */ async getSummary(gameId) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/games/${gameId}/summary`);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$game$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/game.service.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
const GameProvider = ({ children })=>{
    ...
    const performThinking = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GameProvider.useCallback[performThinking]": async (think)=>{
            if (!currentGame) {
                setError("No active game found");
                return;
            }
            ...
            setError(null);
            try {
                const updatedGame = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$game$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].performThinking(currentGame.id, think);
                setCurrentGame(updatedGame);
            } catch (err) {
    ...
    }["GameProvider.useCallback[performThinking]"], [
        currentGame
    ]);
    const performCommunication = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GameProvider.useCallback[performCommunication]": async (communication)=>{
            if (!currentGame) {
                setError("No active game found");
                return;
            }
            ...
            setError(null);
            try {
                const updatedGame = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$game$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].performCommunication(currentGame.id, communication);
                setCurrentGame(updatedGame);
            } catch (err) {
    ...
    }["GameProvider.useCallback[performCommunication]"], [
        currentGame
    ]);
    const getSummary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GameProvider.useCallback[getSummary]": async ()=>{
            if (!currentGame) {
                setError("No active game found");
            ...
            setError(null);
            try {
                const summary = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$game$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getSummary(currentGame.id);
                return summary;
            } catch (err) {
...
//# sourceMappingURL=src_dc446d86._.js.map