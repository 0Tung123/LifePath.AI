...
export default function GamePlayPage({
  ...
  if (loading) {
    return <LoadingScreen message="Đang tải phiên game..." />;
  }
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="container mx-auto p-6">
            <div className="mb-8">
              {gameSession.currentStoryNode?.content && (
                <TypewriterEffect
              ...
              <div className="mb-6">
                ...
                gameSession.character.skills.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {gameSession.character.skills.map((skill: string) => (
                      <span
                        key={skill}
          ...
          <div className="w-80 bg-gray-800 border-l border-gray-700 overflow-y-auto">
            ...
            <div className="p-4">
              ...
              gameSession.gameState.questLog.length > 0 ? (
                <div className="space-y-4">
                  {gameSession.gameState.questLog.map(
