...
export default function GamePage({
  ...
  }, [isAuthenticated, gameId, loadGame]); // loadGame is now memoized
        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">
              The adventure you're looking for doesn't exist or you don't have
              access to it.
            </p>
            <button
          ...
          {activeTab === "story" && (
            <div className="relative h-[70vh] flex flex-col">
              ...
              >
                ...
                {currentGame.storyHistory &&
                  currentGame.storyHistory.length > 0 && (
                    <div className="space-y-8">
                      {currentGame.storyHistory.map(
              ...
              <div className="border-t border-gray-700 bg-gray-800/95 backdrop-blur-sm p-6">
                {currentGame.currentChoices &&
                      ...
                      <div className="mt-6 pt-4 border-t border-gray-600/30">
                        ...
                        >
                          <div className="flex items-center justify-center space-x-2">
                            ...
                            <span>{showCustomAction ? "Hide Custom Action" : "Write Your Own Action"}</span>
                          </div>
                        </button>
                      </div>
                    </div>
                  ...
                  {currentGame?.currentChoices && 
                   ...
                   showCustomAction && 
                   !processingChoice && (
                    <div className="bg-gradient-to-br from-purple-900/20 to-purple-800/10 rounded-lg p-6 border border-purple-400/30 backdrop-blur-sm">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-400">
                            {customAction.length}/500 characters
                          </span>
