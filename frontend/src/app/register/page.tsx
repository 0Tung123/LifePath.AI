...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-purple-900 text-white flex items-center justify-center p-4">
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">
                Đăng ký để bắt đầu cuộc phiêu lưu của bạn
              </p>
            </div>
