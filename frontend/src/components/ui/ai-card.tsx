...
export function AICard({
  ...
  const baseClasses = "relative rounded-lg overflow-hidden bg-card text-card-foreground";
  
  const variantClasses = {
    default: "",
    hover: "group transition-all duration-300",
    interactive: "cursor-pointer transition-all duration-300 hover:scale-[1.02]",
  ...
  const hoverClasses = hoverable ? "hover:border-primary/50 hover:shadow-md" : "";
