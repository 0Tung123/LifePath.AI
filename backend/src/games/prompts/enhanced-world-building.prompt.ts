/**
 * Enhanced World Building Prompt for LifePath.AI
 * 
 * This prompt implements advanced world-building techniques to create
 * a more immersive, dynamic, and responsive game world.
 */

export const buildEnhancedWorldPrompt = (gameSettings: any): string => {
 ...
 */
export const buildEnhancedActionPrompt = (game: any, choiceNumber?: number, action?: string, think?: string, communication?: string): string => {
  // Get the style from game settings
