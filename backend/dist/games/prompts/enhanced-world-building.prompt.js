...
exports.buildEnhancedActionPrompt = exports.buildEnhancedWorldPrompt = void 0;
const buildEnhancedWorldPrompt = (gameSettings) => {
...
exports.buildEnhancedWorldPrompt = buildEnhancedWorldPrompt;
const buildEnhancedActionPrompt = (game, choiceNumber, action, think, communication) => {
...
`;
    ...
    if (game.characterSkills.length === 0) {
        ...
        game.characterSkills.forEach((skill) => {
            ...
            if (skill.level)
                skillDesc += ` (Cấp ${skill.level})`;
            if (skill.mastery)
                skillDesc += ` (${skill.mastery})`;
...
exports.buildEnhancedActionPrompt = buildEnhancedActionPrompt;
//# sourceMappingURL=enhanced-world-building.prompt.js.map